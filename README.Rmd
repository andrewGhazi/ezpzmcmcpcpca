...
Nonetheless, this doesn't always work. If you notice component(s) of `W_id` that seem to be symmetrically flipping about zero, that means there's substantial probability that the posterior mean isn't pointing in the right direction.
